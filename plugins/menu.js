...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
  try {
    ...
    conn.sendHydrated(m.chat, text.trim(), author, pp, 'https://api.whatsappfeedbac.repl.co/', 'Website', null, null, [['Donasi', '/donasi'], ['Speed', '/ping'], ['Owner', '/owner']], m)
    conn.sendFile(m.chat, fs.readFileSync('./src/menu.mp3'), 'menu.mp3', '', m, true)
  } catch (e) {
